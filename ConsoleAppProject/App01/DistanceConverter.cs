...
{
    /// <summary>
    /// It is a distance converter which converts the distance in different forms.
    /// </summary>
    /// <author>
    /// Aashish version 0.1
    /// </author>
 ...
 public double Miles; public double Feets;
 ...
 public void run()
 {
Console.WriteLine("Enter from distance: ");
From_distance = UnitMenu();
Console.WriteLine("Enter to distance: ");
...
{
    Console.WriteLine("Choose the unit for conversion process!");
