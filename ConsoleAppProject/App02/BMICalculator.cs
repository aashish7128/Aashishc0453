...
public class BMICalculator
{
  ...
  /*  public static IHostBuilder CreateHostBuilder(string[] args) =>
    ...
    static void calculate_bmi_imperial(double heightFeet, double heightInches, double weightStones, double weightPounds)
    {
        ...
        Console.WriteLine("If you are Black, Asian or other minority ethnic groups, you are in high risk. Adult 23 and more are considered in higher risk Adults 27 and above are in high risk\r\n");
    }
